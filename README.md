# Joe's [NixOS]  & [Home Manager] Configurations
...
| :------------: | :------------: | :-----------------: | :-----------: | :----------: | :------- |
| `hydrogen`     | Beelink        | Ryzen 9 5900HX      | NixOS         | Desktop      | WIP      |
| `helium`       | Odroid         | H3                  | NixOS         | Server       | WIP      |
| `carbon`       | Lenovo         | ThinkPad X1 Gen 8   | NixOS         | Laptop       | WIP      |
| `oxygen`       | Dell           | XPS 13 9350         | NixOS         | Laptop       | WIP      |
| `nitrogen`     | Odroid         | H3+                 | NixOS         | Server       | WIP      |
| `gold`         | Dell           | Optiplex 7010       | NixOS         | Server       | WIP      |
| `silver`       | Dell           | Optiplex 7010       | NixOS         | Server       | WIP      |
| `umbrel`       | Raspberry Pi   | Raspberry Pi 4 4GB  | Umbrel        | Server       | tbn      |
| `neon`         | Raspberry Pi   | Raspberry Pi 4 8GB  | Nixos         | Server       | tbn      |
| `lithium`      | VM             |                     | Nixos         | Desktop      | tbn      |
...
![neofetch on hydrogen](.github/screenshots/neofetch.png)
...
![Pantheon on hydrogen](.github/screenshots/pantheon.png)
...
- [x] Create standard directories in `/home/joe` using `systemd.user.tmpfiles.rules`.
- [x] Create `.envrc` files in `/home/joe`.
