{ config, desktop, hostname, inputs, lib, modulesPath, outputs, pkgs, stateVersion, username, ... }: {
  ...
  networking = {
    extraHosts = ''
      192.168.192.40  nitrogen-zt
      192.168.192.59  silver-zt
      192.168.193.59  silver-gaming
      192.168.192.181 carbon-zt
      192.168.192.220 helium-zt
      192.168.193.220 helium-gaming
      192.168.192.162 oxygen-zt
      192.168.192.249 neon-zt
      #192.168.192.0   gold-zt
    '';
    hostName = hostname;
