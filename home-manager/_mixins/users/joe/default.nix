{ lib, hostname, username, ... }: {
  ...
  home = {
    ...
    file.".bazaar/bazaar.conf".text = "
      [DEFAULT]
      email = Joe Sullivan <joe@truckstop.cloudoud>
    ...
    file."Quickemu/nixos-console.conf".text = ''
      #!/run/current-system/sw/bin/quickemu --lithium
      guest_os="linux"
    ...
    '';
    sessionVariables = {
      BZR_EMAIL = "Joe Sullivan <joe@truckstop.cloud>";
      DEBFULLNAME = "Joe Sullivan";
      DEBEMAIL = "joe@truckstop.cloud";
